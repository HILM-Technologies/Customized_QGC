...
Rectangle {
    ...
    property real _headingToHome:               vehicle && vehicle.headingToHome ? vehicle.headingToHome.rawValue : 0
    property real _groundSpeed:                 vehicle && vehicle.groundSpeed ? vehicle.groundSpeed.rawValue : 0
    property real _headingToNextWP:             vehicle && vehicle.headingToNextWP ? vehicle.headingToNextWP.rawValue : 0
    property real _courseOverGround:            vehicle && vehicle.gps && vehicle.gps.courseOverGround ? vehicle.gps.courseOverGround.rawValue : 0
